...
static inline int generate_castle_key_index()
{
    int castle_idx = 0;
...
static inline uint64_t generate_hash_key()
{
...
static inline int readHashEntry(int depth, int alpha, int beta, MOVE &best_move)
{
...
static inline void writeHashEntry(int depth, int evaluation, MOVE best_move, int hash_flag)
{
